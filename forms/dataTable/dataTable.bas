...
// an array of arrays. One array for each row.
 var data1 = [
    ...
    ["Paul Kruse", "Student", "Heilbronn", "5021","2010/11/20", "$200,000"],
    ["Derek Richard ", "Student", "Omaha", "8267","2009/03/11", "$450,000"],
];
...
Function dataTable_onshow()
  NSB.MsgBox("Added both of our names + additional data to the end of the table")
End Function
